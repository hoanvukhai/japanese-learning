...
import { Layers, GitMerge, Keyboard, Lock, ArrowLeft, BookOpen, CheckSquare, ShieldAlert, Zap } from 'lucide-react';
...
export default function VocabDashboard() {
  ...
  const modes = [
    ...
    },
    {
      ...
      path: '/practice/vocabulary/fullrun',
      icon: Zap,
      desc: lang === 'en'
        ...
        >
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-3 mb-2">
              ...
              <span className="px-2.5 py-0.5 bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-400 text-xs font-bold rounded-full">
                JLPT N3
              </span>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              to="/study/vocabulary"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white font-bold text-sm px-4 py-2 rounded-full shadow-md hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
              <BookOpen size={14} />
              {t.studyBtn}
            </Link>
